            ...
            <React.Fragment>
                <Navbar className="bg-dark" dark expand="md">
                    <div className="container">
                        ...
                        <NavbarBrand className="logo__nav mr-auto" href="/"><img src='assets/images/logo.png' height="30" width="41" alt='Ristorante Con Fusion' /></NavbarBrand>
                        <Collapse isOpen={this.state.isNavOpen} navbar>
                            ...
                            <Nav navbar className="ml-auto">
                                <NavItem>
                                    <Button onClick={this.toggleModal}><span className="fav fav-icon-sign-in fa-lg"></span>Login</Button>
                                </NavItem>
                            </Nav>
                        </Collapse>
                    </div>
